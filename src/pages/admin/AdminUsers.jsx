          ...
          <table className="w-full border border-gray-300 dark:border-gray-600">
            ...
            <tbody>
              {users.map((e, i) => (
                <tr
                  key={e._id}
                  className="group hover:bg-white dark:hover:bg-gray-700 text-gray-400 dark:text-gray-400 transition"
                >
                  <td className="p-3 border dark:border-gray-600 group-hover:text-black">
                    {i + 1}
                  </td>
                  <td className="p-3 border dark:border-gray-600 group-hover:text-black">
                    {e.username}
