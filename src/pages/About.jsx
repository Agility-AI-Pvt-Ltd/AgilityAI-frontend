      ...
      <section className="py-24 relative">
        <div className="w-full max-w-7xl px-4 md:px-5 lg:px-5 mx-auto">
          <div className="w-full justify-start items-center gap-12 grid lg:grid-cols-2 grid-cols-1">
            ...
            <div className="w-full max-w-5xl mx-auto px-4 lg:px-0 mt-20">
              <div className="flex flex-col gap-8 lg:items-start items-center text-center lg:text-left">
                ...
                <p className="text-gray-300 text-lg leading-relaxed text-justify">
                  ...
                  mere buzzword into a powerful force for progress that everyone
                  can access.
                </p>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
            ...
            <div className="max-w-xl text-center lg:text-start">
              <h2 className="text-[#F5FCE1] text-3xl sm:text-4xl lg:text-5xl font-bold font-manrope leading-tight">
                Our Mission
              </h2>
              <p className="text-gray-300 text-lg font-light mt-6 leading-relaxed">
      ...
      <section className="py-16 text-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-12 grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-gray-300 text-lg mb-6 leading-relaxed text-center lg:text-start max-w-3xl mx-auto">
